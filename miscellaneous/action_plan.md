...
3.1 Как да разцепя датасета за трейн/тест? 70/30 май ще стане ако махна юзъри с малко на брой реийтинги.
...
8. ~~RNN. Сравни с 5. И 7.~~ → MLP (Multi-Layer Perceptron). Сравни с 5. и 7. +тестове
